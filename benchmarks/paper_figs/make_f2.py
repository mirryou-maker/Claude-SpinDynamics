...
ax.set_xlabel("L (nm)"); ax.set_ylabel("E (aJ)"); ax.set_title("(a) SP#1 phase: $L_c$"); ax.legend(fontsize=8); ax.grid(alpha=0.3)
...
ax.set_xlabel("$H$ (mT)"); ax.set_ylabel(r"$\langle m_x\rangle$")
...
ax.set_xlabel("t (ns)"); ax.set_ylabel(r"$\langle m\rangle$")
...
ax.plot(sp5[0,1], sp5[0,2], "go", label="start"); ax.plot(sp5[-1,1], sp5[-1,2], "rs", label="t=8ns")
