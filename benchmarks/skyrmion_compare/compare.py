...
print("Same Q sign & polarity (Claude-SD seed convention now matches mumax3: pol=+1 core up);")
print("same up-right trajectory and deformation (mumax3 J sign chosen to match the SOT drive direction).")
