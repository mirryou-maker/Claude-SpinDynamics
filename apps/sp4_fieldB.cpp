// µMAG Standard Problem #4  —  Field B  (190°)
// Same geometry/material as sp4.cpp, field angle changed to 190°.
// In Field B the Hy component is negative (Hy = 25mT × sin(190°) ≈ -3.45 kA/m)
// vs Field A where Hy > 0.  Both cases show switching but via different paths.
//
// µMAG reference (Field B, 2.5×2.5×3 nm mesh):
...
int main() {
    ...
    std::cout << "=== µMAG SP#4  Field B (190°) ===\n";
    ...
    std::cout << "\n=== Final state ===\n";
    std::cout << "  <mx> = " << smx << "  (µMAG ref ≈ –0.9839)\n";
    std::cout << "  <my> = " << smy << "\n";
    std::cout << "  <mz> = " << smz << "\n";
